...
CREATE INDEX inx_auth_user_tokens_user
  ON auth_user_tokens (id_user);

CREATE INDEX inx_auth_user_tokens_type
  ON auth_user_tokens (token_type);

CREATE INDEX inx_auth_user_tokens_expires
  ON auth_user_tokens (expires_at);
