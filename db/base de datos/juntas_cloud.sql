...
-- =========================================================
--  TABLA: caja_movimientos (cambiado)
--  - antes: id_usuario -> usuarios(tenant,id_usuario)
--  - ahora: id_user -> auth_users(id_user) (usuario global)
-- =========================================================
...
CREATE POLICY tenants_by_membership
ON tenants
USING (
  EXISTS (
    SELECT 1
