...
export class FaenaParticipacionResponseDto {
  @ApiProperty({ example: 1 })
  idTenant!: number;

  @ApiProperty({ example: 1 })
  idFaenaParticipacion!: number;
  ...
  @ApiProperty({ type: String, nullable: true, example: '1970-01-01T08:30:00.000Z' })
  ...
  @ApiProperty({ type: Number, nullable: true, example: 10.5 })
